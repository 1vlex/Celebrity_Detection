...
Тяжёлые данные (видео, кропы, ZIP-архив) не кладутся в git —
они попадают в папки, которые перечислены в `.gitignore`.

---

## Дисклеймер

Проект использует видео с YouTube через `yt-dlp`.  
Уважай правила платформы и права на контент, не выкладывай в открытый доступ
сырые видео/фрагменты, если это нарушает условия использования.
